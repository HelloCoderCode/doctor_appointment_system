...
urlpatterns = [
    ...
    path('patient-take-appointment/confirm/<pk>', TakeAppointmentConfirmView.as_view(), name='take-appointment-confirm'),
    path('patient-take-appointment/confirm/<pk>/pdf', TakeAppointmentPdfView.as_view(), name='take-appointment-pdf'),
